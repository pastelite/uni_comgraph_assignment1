    ...
    int x2, int y2, int r2, int g2, int b2)
{
    ...
    l03_g = g1;
    l03_b = b1;
    // Scan the first half of the triangle (between l1 and l2)
    // TODO: handle the case when x0==x1 
    if (x0 == x1) {
        if (l02_y >= l01_y) {
            FillScanLine(x0, l02_y, l02_r, l02_g, l02_b, l01_y, l01_r, l01_g, l01_b);
        }
        else {
            FillScanLine(x0, l01_y, l01_r, l01_g, l01_b, l02_y, l02_r, l02_g, l02_b);
        }
    }

    for (x = x0; x < x1; x++) {
        // If I understand this correctly, FillScanLine will fills thing from top to bottom in a straight line
        if (l02_y >= l01_y) {
    ...
    // Scan the second half of the triangle (between l2 and l3)
    // TODO: handle the case when x1==x2 
    if (x1 == x2) {
        if (l02_y >= l03_y) {
            FillScanLine(x1, l02_y, l02_r, l02_g, l02_b, l03_y, l03_r, l03_g, l03_b);
        }
        else {
            FillScanLine(x1, l03_y, l03_r, l03_g, l03_b, l02_y, l02_r, l02_g, l02_b);
        }
    }
